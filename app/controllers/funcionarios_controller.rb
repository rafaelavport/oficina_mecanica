class FuncionariosController < ApplicationController
  ...
  def create
    ...
    @funcionario.equipe = Equipe.find(params[:funcionario][:equipe_id])

    respond_to do |format|
      if @funcionario.save
        format.html { redirect_to funcionario_url(@funcionario), notice: "Funcionario criado com sucesso.." }
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :funcao, :equipe_id)
    end
end
